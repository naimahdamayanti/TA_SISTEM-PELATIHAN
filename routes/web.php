...
Route::middleware('auth')->group(function () {
    ...
    // Dashboard (role-aware, satu route, dispatch di controller)
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // Dashboard admin (alias agar link sidebar langsung)
        Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');

        // Kelola Pelatihan
        Route::resource('pelatihan', PelatihanController::class)->parameters(['pelatihan' => 'pelatihan']);

        // Kelola Sesi Pelatihan (nested di bawah pelatihan)
