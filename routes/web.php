...
use App\Http\Controllers\Web\KodePenerimaanController;     
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::resource('instruktur', InstrukturController::class)->parameters(['instruktur' => 'user']);
        Route::post('/instruktur/tugaskan',            [InstrukturController::class, 'tugaskan'])->name('instruktur.tugaskan');
        Route::patch('/instruktur/{user}/verifikasi',  [InstrukturController::class, 'verifikasi'])->name('instruktur.verifikasi');

        Route::get('/kode-penerimaan',                                [KodePenerimaanController::class, 'index'])->name('kode-penerimaan.index');
        Route::post('/kode-penerimaan',                               [KodePenerimaanController::class, 'store'])->name('kode-penerimaan.store');
        Route::post('/kode-penerimaan/{kodePenerimaan}/kirim-email',  [KodePenerimaanController::class, 'kirimEmail'])->name('kode-penerimaan.kirim-email');
        Route::delete('/kode-penerimaan/{kodePenerimaan}',            [KodePenerimaanController::class, 'destroy'])->name('kode-penerimaan.destroy');
